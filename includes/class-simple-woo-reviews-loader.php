 ...
 */
class Simple_Woo_Reviews_Loader {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      array    $actions    The actions registered with WP to fire when the plugin loads.
	 */
	protected $actions;
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      array    $filters    The filters registered with WP to fire when the plugin loads.
	 */
	protected $filters;
	...
	/**
	 * Add a new action to the collection to be registered with WP.
	 *
	 * @since    1.0.0
	 * @param    string               $hook             The name of the WP action that is being registered.
	...
	/**
	 * Add a new filter to the collection to be registered with WP.
	 *
	 * @since    1.0.0
	...
	/**
	 * Register the filters and actions with WP.
	 *
	 * @since    1.0.0
	 */
	function run() {
